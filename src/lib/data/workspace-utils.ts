...
export const CLIENT_SELECT =
  "id, name, brand_voice, compliance_notes, brand_url, primary_category, target_demographic, primary_platforms, certifications, key_brand_claims, competitors, internal_notes";
